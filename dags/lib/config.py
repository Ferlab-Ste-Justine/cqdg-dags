...
arranger_image = 'ferlabcrsj/cqdg-api-arranger:v1.1.0'
...
if env == Env.QA:
    ...
    spark_index_jar = 'https://github.com/Ferlab-Ste-Justine/etl-cqdg-portal/releases/download/v1.1.8/index-task.jar'
    spark_publish_jar = 'https://github.com/Ferlab-Ste-Justine/etl-cqdg-portal/releases/download/v1.1.8/publish-task.jar'
