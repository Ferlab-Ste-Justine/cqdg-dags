...
if env == Env.QA:
    ...
    spark_index_jar = 'https://github.com/Ferlab-Ste-Justine/etl-cqdg-portal/releases/download/v1.1.15/index-task.jar'
    spark_publish_jar = 'https://github.com/Ferlab-Ste-Justine/etl-cqdg-portal/releases/download/v1.1.15/publish-task.jar'
